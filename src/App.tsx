...
const DEFAULT_CONFIG: Pengaturan = {
  Nama_Guru: "Al-Kahpi, S.Pd.",
  NIP_Guru: "198208242011011001",
  Pemerintah: "PEMERINTAH KOTA TARAKAN",
  Nama_Sekolah: "SMP NEGERI 10 TARAKAN",
  Alamat_Sekolah: "Jl. Amal Lama RT. 4 Kel. Pantai Amal Kec. Tarakan Timur Kota Tarakan",
  Nama_Kepsek: "IBRAHIM, M.Pd.",
  NIP_Kepsek: "197802152008011021",
  Tempat_Tanda_Tangan: "Tarakan",
...
const AI_TOOLS_ITEMS = [
  { id: "perangkat_kbc", label: "Perangkat Ajar KBM", icon: HeartHandshake, desc: "ACP, TP, ATP, Prota, Prosem, KKTP, Modul, LKPD & Rubrik KBM", badge: "KBM" },
