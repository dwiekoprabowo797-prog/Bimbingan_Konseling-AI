...
export const GeneratorSoalAIView: React.FC<GeneratorSoalAIViewProps> = ({ config }) => {
  ...
  const [kartuFormData, setKartuFormData] = useState({
    ...
    mainTopic: "Laporan Hasil Observasi Siswa (Studi Kasus/Asesmen)",
    duration: "90 Menit",
  ...
  const [naskahFormData, setNaskahFormData] = useState({
    ...
    cityDate: `${config.Tempat_Tanda_Tangan || "Tarakan"}, 1 Desember 2026`,
    principal: config.Nama_Kepsek || "IIBRAHIM, M.Pd.",
    nipPrincipal: config.NIP_Kepsek || "197802152008011021",
    logoUrl: config.Logo_Kiri || config.Logo_Kanan || "https://lh3.googleusercontent.com/d/1i82llPU1_OoXCVIVQKOHVrRNkV1Cc5Ho",
    sumberMateri: ""
  });
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-xs">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white font-medium focus:ring-2 focus:ring-blue-500 outline-none"
                  placeholder="Contoh: Bimbingan Konseling"
                />
              </div>
