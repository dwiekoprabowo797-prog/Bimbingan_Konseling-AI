...
export const ModulKokurikulerAIView: React.FC<ModulKokurikulerAIViewProps> = ({ config }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    grade: "Kelas VIII",
    topic: "Suara Demokrasi dan Anti-Bullying: Mewujudkan Sekolah Ramah Anak",
    duration: "3 JP (3 x 40 Menit)",
    location: "Lingkungan Taman Sekolah & Gazebo Adiwiyata Sekolah",
    dimensions: ["Penalaran Kritis", "Kolaborasi"],
    subject1: "Bimbingan Konseling",
    subject2: "PPKn",
    pedagogicalPractice: "Pembelajaran Berbasis Proyek (Project-Based Learning)",
    learningEnvironment: "Memberi kesempatan siswa untuk mengeksplorasi secara nyata iklim sosial dan kasus perundungan (bullying) di lingkungan sekolah, serta mempraktikkan proses pembuatan sistem pengaduan aman dan kampanye mediasi sebaya",
    partnership: "Kolaborasi lintas mapel PKn (analisis pelanggaran hak asasi manusia, norma hukum, dan regulasi sekolah) dan Bimbingan Konseling (psikoedukasi kesehatan mental, penumbuhan empati, dan mekanisme konseling sebaya), serta pendampingan dari Komisi Perlindungan Anak/Psikolog Anak",
    digitalTools: "Canva untuk infografis kampanye anti-perundungan, Google Forms untuk pembuatan platform pengaduan atau survei kesejahteraan psikologis (well-being) siswa secara anonim, dan podcast/video edukasi stop bullying"
  });
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
          <div>
            ...
            <input
              ...
              placeholder="Contoh: SMP NEGERI 10 TARAKAN"
            />
          </div>
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            placeholder="Contoh: Jiwa Sehat, Negara Kuat: Kampanye Sekolah Bebas Perundungan"
          />
        </div>
